...
namespace lucus
{
    ...
    namespace utils
    {
        ...
        void createTextureImage(texture* tex, VkDevice device, VkPhysicalDevice gpu, VkBuffer& stgBuffer, VkDeviceMemory& stgBufferMemory, VkImage& texImage, VkDeviceMemory& texImageMemory, VkDeviceSize& texSize, VkExtent2D& texExtent);
