...
void vk_render_pass::cleanup(VkDevice device)
{
...
void vk_framebuffer::init(VkDevice device, const vk_viewport& viewport, VkRenderPass renderPass)
{
    frameBuffers.resize(viewport.imageViews.size());
...
void vk_framebuffer::cleanup(VkDevice device)
{
